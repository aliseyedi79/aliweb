...
export default function GalleyComponent() {
  ...
  const pic = [
    { src: '/1.jpg', alt: 'aliseyyedi-pic' },
    { src: '/2.jpg', alt: 'aliseyyedi-pic' },
    { src: '/3.jpg', alt: 'aliseyyedi-pic' },
    { src: '/4.jpg', alt: 'aliseyyedi-pic' },
    { src: '/5.jpg', alt: 'aliseyyedi-pic' },
    { src: '/6.jpg', alt: 'aliseyyedi-pic' },
  ];
